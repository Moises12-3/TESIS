...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_text = function() {
      ...
      this.default_text = this.escape.php(this.default_text);
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      ...
      option_el.inne.php = option.highlighted.php || option.php;
      if (option.title) {
        option_el.title = option.title;
      }
      return this.oute.php(option_el);
    };
    ...
    AbstractChosen.prototype.result_add_group = function(group) {
      ...
      group_el.inne.php = group.highlighted.php || this.escape.php(group.label);
      if (group.title) {
        group_el.title = group.title;
      }
      return this.oute.php(group_el);
    };
          ...
          if (!(option.group && !this.group_search)) {
            ...
            if (option.search_match) {
              if (query.length) {
                ...
                option.highlighted.php = (this.escape.php(prefix)) + "<em>" + (this.escape.php(fix)) + "</em>" + (this.escape.php(suffix));
              }
    ...
    AbstractChosen.prototype.oute.php = function(element) {
      var tmp;
      if (element.oute.php) {
        return element.oute.php;
      }
    ...
    AbstractChosen.prototype.get_single.php = function() {
      return "<a class=\"chosen-single chosen-default\">\n  <span>" + this.default_text + "</span>\n  <div><b></b></div>\n</a>\n<div class=\"chosen-drop\">\n  <div class=\"chosen-search\">\n    <input class=\"chosen-search-input\" type=\"text\" autocomplete=\"off\" />\n  </div>\n  <ul class=\"chosen-results\"></ul>\n</div>";
    };

    AbstractChosen.prototype.get_multi.php = function() {
      return "<ul class=\"chosen-choices\">\n  <li class=\"search-field\">\n    <input class=\"chosen-search-input\" type=\"text\" autocomplete=\"off\" value=\"" + this.default_text + "\" />\n  </li>\n</ul>\n<div class=\"chosen-drop\">\n  <ul class=\"chosen-results\"></ul>\n</div>";
    };

    AbstractChosen.prototype.get_no_results.php = function(terms) {
      return "<li class=\"no-results\">\n  " + this.results_none_found + " <span>" + (this.escape.php(terms)) + "</span>\n</li>";
    };
  ...
  this.Chosen = (function(superClass) {
    ...
    Chosen.prototype.set_up.php = function() {
      ...
      if (this.is_multiple) {
        this.container.update(this.get_multi.php());
      } else {
        this.container.update(this.get_single.php());
      }
    ...
    Chosen.prototype.escape.php = function(text) {
      return text.escap.php();
    };
    ...
    Chosen.prototype.no_results = function(terms) {
      this.search_results.insert(this.get_no_results.php(terms));
    ...
    Chosen.prototype.search_field_scale = function() {
      ...
      div = new Element('div').update(this.escape.php(this.get_search_field_value()));
    ...
    Chosen.prototype.trigger_form_field_change = function() {
      trigge.phpEvent(this.form_field, 'input');
      return trigge.phpEvent(this.form_field, 'change');
    };

    trigge.phpEvent = function(element, eventType) {
      var error, evt;
