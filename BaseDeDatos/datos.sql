...
USE ventas_php;
    ...
    ('Quetzal', 'GTQ', 'nacional', 'Guatemala', 'activo', 7.80),
    ('Córdoba', 'NIO', 'nacional', 'Nicaragua', 'activo', 35.00),
    ('Sol', 'PEN', 'nacional', 'Perú', 'activo', 3.80),
    ('Peso Colombiano', 'COP', 'nacional', 'Colombia', 'activo', 4000.00),
    ('Bolívar', 'VES', 'nacional', 'Venezuela', 'activo', 4000000.00),
    ('Peso Argentino', 'ARS', 'nacional', 'Argentina', 'activo', 250.00),
    ('Guaraní', 'PYG', 'nacional', 'Paraguay', 'activo', 7000.00),
    ('Peso Chileno', 'CLP', 'nacional', 'Chile', 'activo', 850.00),
    ('Dólar de Belice', 'BZD', 'extranjera', 'Belice', 'activo', 2.00),
    ('Peso Cubano', 'CUP', 'nacional', 'Cuba', 'activo', 24.00),
    ('Dólar Jamaiquino', 'JMD', 'extranjera', 'Jamaica', 'activo', 150.00),
    ('Peso Dominicano', 'DOP', 'nacional', 'República Dominicana', 'activo', 55.00),
    ('Boliviano', 'BOB', 'nacional', 'Bolivia', 'activo', 7.00),
    ('Dólar Ecuatoriano', 'USD', 'extranjera', 'Ecuador', 'activo', 1.00),
    ('Peso Uruguayo', 'UYU', 'nacional', 'Uruguay', 'activo', 45.00),
    ('Peso Colombiano', 'COP', 'nacional', 'Colombia', 'activo', 4000.00),
    ('Súcre', 'SUC', 'nacional', 'Ecuador', 'inactivo', NULL),
    ('Dólar Bermudeño', 'BMD', 'extranjera', 'Bermuda', 'activo', 1.00),
    ('Caymán Dólar', 'KYD', 'extranjera', 'Islas Caimán', 'activo', 0.83),
    ('Balboa', 'PAB', 'nacional', 'Panamá', 'activo', 1.00),
    ('Córdoba Oro', 'NIO', 'nacional', 'Nicaragua', 'activo', 35.00),
    ('Dólar de Trinidad y Tobago', 'TTD', 'extranjera', 'Trinidad y Tobago', 'activo', 6.80),
    ('Peso Costarricense', 'CRC', 'nacional', 'Costa Rica', 'activo', 600.00),
    ('Colon', 'CRC', 'nacional', 'El Salvador', 'activo', 8.75),
    ('Dólar de Guyana', 'GYD', 'extranjera', 'Guyana', 'activo', 210.00),
    ('Dólar de Surinam', 'SRD', 'extranjera', 'Surinam', 'activo', 21.00),
    ('Peso Panameño', 'PAB', 'nacional', 'Panamá', 'activo', 1.00);
